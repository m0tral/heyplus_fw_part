 ...
 ***********************************************/
//#include "app_trace.h"
//#define mcube_printf app_trace_log
#define GSENSOR_LOG_RAW_DATA        1
#define BUILD_MCUBE_3610		    0

//#define M_DRV_MC36XX_CFG_BUS_I2C    // !!! DO NOT use both I2C and SPI simutaneously
#define M_DRV_MC36XX_CFG_BUS_SPI    1
...
#define SIGN_AND_REMAP			 0

#define FIFO_DEEP          		 25
#define FIFO_THRESHOLD     		 (FIFO_DEEP)
#define FIFO_BUFF_DEEP           64
#define mcube_printf   ry_board_debug_printf

/*****************************************************************************
 *** DATA TYPE / STRUCTURE DEFINITION / ENUM
 *****************************************************************************/
 typedef struct {
	short RawData[FIFO_BUFF_DEEP][M_DRV_MC_UTL_AXES_NUM];
	short DataLen; 
//	unsigned int TimeStamp[FIFO_BUFF_DEEP]; //ms 
}AccData;
extern AccData* p_acc_data;
...
#ifdef  M_DRV_MC36XX_CFG_BUS_SPI
extern int nordic_spi_init(void);
#endif 
