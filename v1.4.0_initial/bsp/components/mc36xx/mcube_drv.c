...
#define M_DRV_MC36XX_INTR_C_IAH_ACTIVE_HIGH    (0x02)
 ...
 #define M_DRV_MC36XX_REG_CHIP_ID          (0x18)
 ...
 *****************************************/
void _M_DRV_MC36XX_ResetChip(void)
{
	//if(s_debug) M_PRINTF("[%s]", __func__);
 ...
 *********************************************************************/
//static 
void _M_DRV_MC36XX_CfgSniff(void)
{
	//if(s_debug) M_PRINTF("[%s]", __func__);
	_M_DRV_MC36XX_ResetChip();
	_M_DRV_MC36XX_SetBusIF();
...
unsigned char M_DRV_MC36XX_ReadChipId(void)
{
	unsigned char _bChipId = 0;
	
	_M_DRV_MC36XX_REG_READ(M_DRV_MC36XX_REG_CHIP_ID, &_bChipId, 1);
	return _bChipId;
}
/*****************************************
...
int M_DRV_MC36XX_ConfigRegRngResCtrl(E_M_DRV_MC36XX_RANGE eCfgRange, E_M_DRV_MC36XX_RESOLUTION eCfgResolution)
{
	...
	_M_DRV_MC36XX_SetMode((E_M_DRV_MC36XX_MODE)(_M_DRV_MC36XX_REG_MODE_C_MODE(_bPreMode)));
	s_eRange = eCfgRange;
		...
		unsigned char bThreshold)
{
...
#ifdef M_DRV_MC36XX_CFG_WA_10
	{
		...
		if (E_M_DRV_MC36XX_RESOLUTION_12BIT < _M_DRV_MC36XX_REG_RANGE_C_RES(_bRegRANGE_C))
			M_DRV_MC36XX_ConfigRegRngResCtrl( (E_M_DRV_MC36XX_RANGE)(_M_DRV_MC36XX_REG_RANGE_C_RANGE(_bRegRANGE_C)), E_M_DRV_MC36XX_RESOLUTION_12BIT);
	}
#endif
