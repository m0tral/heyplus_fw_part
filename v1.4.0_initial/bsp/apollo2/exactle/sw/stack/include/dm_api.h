...
enum
{
  ...
  DM_ADV_STOP_IND,                        /*! 34 Advertising stopped */
  DM_ADV_NEW_ADDR_IND,                    /*! New resolvable address has been generated */
  DM_SCAN_START_IND,                      /*! 36 Scanning started */
  DM_SCAN_STOP_IND,                       /*! 37 Scanning stopped */
  DM_SCAN_REPORT_IND,                     /*! Scan data received from peer device */
  DM_CONN_OPEN_IND,                       /*! 39 Connection opened */
  DM_CONN_CLOSE_IND,                      /*! 40 Connection closed */
  DM_CONN_UPDATE_IND,                     /*! 41 Connection update complete */
  ...
  DM_SEC_SLAVE_REQ_IND,                   /*! 50 Incoming security request from slave */
  DM_SEC_CALC_OOB_IND,                    /*! 51 Result of OOB Confirm Calculation Generation */
  ...
  DM_PRIV_RESOLVED_ADDR_IND,              /*! 55 Private address resolved */
  ...
  DM_PRIV_READ_PEER_RES_ADDR_IND,         /*! 60 Peer resolving address read */
  DM_PRIV_READ_LOCAL_RES_ADDR_IND,        /*! Local resolving address read */
  DM_PRIV_SET_ADDR_RES_ENABLE_IND,        /*! Address resolving enable set */
  DM_REM_CONN_PARAM_REQ_IND,              /*! 63 Remote connection parameter requested */
  DM_CONN_DATA_LEN_CHANGE_IND,            /*! 64 Data length changed */
  ...
  DM_ADV_SET_START_IND,                   /*! 70 Advertising set(s) started */
  DM_ADV_SET_STOP_IND,                    /*! 71 Advertising set(s) stopped */
  ...
  DM_PER_ADV_SYNC_EST_IND,                /*! 78 Periodic advertising sync established */
  DM_PER_ADV_SYNC_LOST_IND,               /*! 79 Periodic advertising sync lost */
  DM_PER_ADV_REPORT_IND,                  /*! 80 Periodic advertising data received from peer device */
  DM_REMOTE_FEATURES_IND,                 /*! 81 Remote features from peer device */
  DM_ERROR_IND,                           /*! 82 General error */
  DM_VENDOR_SPEC_IND,                     /*! 83 Vendor specific event */
  DM_HW_ERROR_IND,						  /*! 84 HCI Hardware Error event */
};
