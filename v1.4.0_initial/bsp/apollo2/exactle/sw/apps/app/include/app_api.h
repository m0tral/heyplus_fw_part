...
enum
{
  APP_ADV_STATE1,                         /*! Advertising state 1 */    // Disconnect
  APP_ADV_STATE2,                         /*! Advertising state 2 */    // Waiting for connection
  APP_ADV_STATE3,                         /*! Advertising state 3 */    // Pairing
  APP_ADV_STATE4,                         /*! Advertising state 4 */    // Unbound
