...
//
//*****************************************************************************
#define EM9304_PATCHES_NUM_PATCHES          7
#define EM9304_PATCHINFO_NUM_PATCHES        9
...
typedef struct
{
  uint8_t	containerID;
  uint8_t   present;
  uint8_t   location;           // IRAM = 0, OTP = 1
} em9304_patchlist_info_t;
...
extern uint16_t em9304init_status;
extern em9304_patchlist_info_t g_pEm9304PatchesInfo[9];

extern em9304_container_info_t g_pEm9304Patches[7];
