 ...
 */
	 ...
	 */
			...
			#define GDISP_IMAGE_BMP_BLIT_BUFFER_SIZE	(72*24)//(1728)
	#else
			#define GDISP_IMAGE_BMP_BLIT_BUFFER_SIZE	120
	#endif		
 ...
 */
	#ifdef APOLLO_HARDWARE_BLOCK_FLUSH
		#define GDISP_IMAGE_GIF_BLIT_BUFFER_SIZE	(72 * 16)
	#else
		#define GDISP_IMAGE_GIF_BLIT_BUFFER_SIZE	(120)
	#endif
/**
 * @}
 *
