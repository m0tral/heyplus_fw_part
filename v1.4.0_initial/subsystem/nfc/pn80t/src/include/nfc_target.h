...
#define NFA_EE_DISCV_TIMEOUT_VAL    20000  /* Wearable fix: Increased the timeout from 2sec */
#endif
...
/* AID routing support */
#ifndef NFA_ENABLE_AID_ROUTING
#define NFA_ENABLE_AID_ROUTING FALSE
#endif

/* Protocol routing support */
#ifndef NFA_ENABLE_PROTOCOL_ROUTING
#define NFA_ENABLE_PROTOCOL_ROUTING FALSE
#endif
