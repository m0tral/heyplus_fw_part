...
/* Define Android Default stack trace levels and Maximum trace level */
...
/*
 * If BT_TRACE_CFG_LOG_LEVEL is defined and set, controls the Default SDK log
 * behavior as defined in Android Default stack trace levels.
 * Default behavior is set as follows
 * 1. to BT_TRACE_LEVEL_DEBUG in DEBUG configuration
 * 2. to BT_TRACE_LEVEL_NONE in RELEASE configuration
 * 3. to BT_TRACE_LEVEL_ERROR when LOGS_TO_CONSOLE is defined
 */
#ifndef LOGS_TO_CONSOLE
#if defined(DEBUG)
#define BT_TRACE_CFG_LOG_LEVEL BT_TRACE_LEVEL_DEBUG
#else
#define BT_TRACE_CFG_LOG_LEVEL BT_TRACE_LEVEL_NONE
#endif

#else
#define BT_TRACE_CFG_LOG_LEVEL BT_TRACE_LEVEL_ERROR
#endif
