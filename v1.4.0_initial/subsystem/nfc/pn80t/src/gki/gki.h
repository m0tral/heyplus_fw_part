...
/* Task management
*/
GKI_API extern UINT8   GKI_create_task (TASKPTR, UINT8, INT8 *, UINT16 *, UINT16, void*);
...
#else
GKI_API extern void    GKI_send_msg   (UINT8, UINT16, void *);
#endif
...
#else
GKI_API extern UINT32  GKI_start_timer (UINT8, INT32, UINT16);
#endif
GKI_API extern void    GKI_stop_timer (UINT8, UINT32);
...
GKI_API extern GKI_tBinarySem GKI_binary_sem_init(void);
GKI_API extern void GKI_binary_sem_destroy(GKI_tBinarySem semaphore);
GKI_API extern void GKI_binary_sem_post(GKI_tBinarySem semaphore);
GKI_API extern void GKI_binary_sem_wait(GKI_tBinarySem semaphore);
GKI_API extern UINT8 GKI_binary_sem_wait_timeout(GKI_tBinarySem semaphore, UINT32 timeout);
GKI_API extern void GKI_kill_task(void * taskhandle);
