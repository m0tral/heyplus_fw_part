...
**                  pwr_cfgis the power configuration(NFCC_DECIDES,POWER_ALWAYS_ON,LINK_ALWAYS_ON)
**                  to be enabled.
**
** Returns          NFA_STATUS_OK if successfully initiated
**                  NFA_STATUS_FAILED otherwise
...
**
*******************************************************************************/
NFC_API extern  tNFA_STATUS NFA_EeSetPwrLink(tNFA_HANDLE    ee_handle,
