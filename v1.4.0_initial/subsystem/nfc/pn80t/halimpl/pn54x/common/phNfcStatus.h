...
/*
 * FW version error while performing NFC Stack Init,
 * If FW version is not as per the Expected FW Version of middle-ware Release then this error is returned
 */
#define NFCSTATUS_FW_UNEXPECTED_VERSION                       (0x003D)
/*
 * Signature Mismatch in Firmware. This error is returned when Dev Key Firmware is installed
 * on Production device or vice versa.
 */
#define NFCSTATUS_FW_SIGNATURE_MISMATCH                       (0x003E)
