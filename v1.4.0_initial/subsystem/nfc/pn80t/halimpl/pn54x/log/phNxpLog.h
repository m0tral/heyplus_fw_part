...
#if defined(DEBUG) && (NXP_PACKET_TRACES == TRUE)
/* define log module included when compile */
#define ENABLE_EXTNS_TRACES   FALSE//TRUE
#define ENABLE_HAL_TRACES     FALSE
//temporarily changed it to avoid i2c failure , due to log I2c was failing could be some timing issue
#define ENABLE_TML_TRACES     FALSE
#define ENABLE_FWDNLD_TRACES  FALSE //FALSE//TRUE
