...
/* RF Technology */
#if defined(NFC_RF_TECHNOLOGY_A)
#undef NFC_RF_TECHNOLOGY_A
#undef NFC_RF_TECHNOLOGY_B
#undef NFC_RF_TECHNOLOGY_F
#endif
typedef enum
{
    NFC_RF_TECHNOLOGY_A,
...
/* Bit rates */
#if defined(NFC_BIT_RATE_106)
#undef NFC_BIT_RATE_106
#undef NFC_BIT_RATE_212
#undef NFC_BIT_RATE_424
#undef NFC_BIT_RATE_848
#endif
typedef enum
{
    NFC_BIT_RATE_106,
...
typedef struct phNxpNciSelTest_Control
{
    int thread_running;
    void *test_rx_task;
    void *halClientSemaphore;
} phNxpNciSelfTest_Control_t;
 ...
 **
 ** Description      Test function to validate the pin connection. Pin value is
 **                  sent as parameter to the API.
 **
 ** Returns          NFCSTATUS_SUCCESS if successful,otherwise NFCSTATUS_FAILED.
 **
 *******************************************************************************/
